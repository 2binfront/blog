    ...
    <div class="comment-list">
        ...
        <div v-for="(item, i) in state.comments" :key="item.id" class="item">
            <div class="item-header">
                <div class="author">
                    <div class="avatar">
                        <img v-if="!item.user_info.avatar" alt="默认图片" src="../assets/user.png" />
            ...
            <div class="item-comment">
                <div class="message" @click="showCommentModal(item.id, item.user_info.id)">
            ...
            <div v-for="e in item.comment_replies" :key="e._id" class="item-other">
                <div class="item-header">
                    <div class="author">
                        <div class="avatar">
                            <img v-if="!e.user_info.avatar" alt="默认图片" src="../assets/user.png" />
        ...
        <Comment :article_id="article_id" :forArticle="false" :reply="state.comment_id" :show-dialog="state.visible"
