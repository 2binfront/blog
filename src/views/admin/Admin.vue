    ...
    <div class="body">
        <div class="menu">
            <el-menu :default-active="state.activePath" :router="true">
                ...
                <el-menu-item index="TagManagement" route="/admin/tag"><i class="el-icon-collection-tag"></i> 标签
                </el-menu-item>
                <el-menu-item index="CommentManagement" route="/admin/comment"><i class="el-icon-chat-line-round"></i>
                    评论
                </el-menu-item>
